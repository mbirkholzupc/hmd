...
#print(orig_theta)
#changeit=np.array([])
#for i in range(int(len(orig_theta)/3)):
#    rjx=rand_joint_xform()
#    changeit=np.concatenate((changeit,rjx))
#print(changeit)
#corrupt_theta=entry[1]+changeit
#corrupt_beta=entry[2]
#print(corrupt_theta)

corrupt_theta=entry[3]
corrupt_beta=entry[4]

corrected_theta=np.zeros((72,))
corrected_theta[0]=math.pi
corrected_beta=np.zeros((10,))
